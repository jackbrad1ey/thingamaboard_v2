...
pub const DEFAULT_LAYER_MAPPING: [[KeyCode; NUM_COLS]; NUM_ROWS] = [
    ...
    [Exclamation, Z, X, C, D, V, Empty, Empty, K, H, Comma, Period, ForwardSlash, BackSlash],
    [Empty, Empty, Empty, LeftAlt, LeftCtrl, LayerShift1, Space, Backspace, Enter, LayerShift2, PrintScreen, Empty, Empty, Empty],
];

#[rustfmt::skip]
pub const NUMPAD_NAV_LAYER_MAPPING: [[KeyCode; NUM_COLS]; NUM_ROWS] = [
    [F8, F9, F10, F11, F12, Empty, Empty, Empty, Minus, Num1, Num2, Num3, Asterisk, Empty],
