...
pub const DEFAULT_LAYER_MAPPING: [[KeyCode; NUM_COLS]; NUM_ROWS] = [
    [Tab, Q, W, F, P, B, CapsLock, Delete, J, L, U, Y, Semicolon, Escape],
    [LeftShift, A, R, S, T, G, LeftMeta, Empty, M, N, E, I, O, SingleQuote],
    [Exclamation, Z, X, C, D, V, Empty, Empty, K, H, Comma, Period, ForwardSlash, Empty],
    [Empty, Empty, Empty, LeftAlt, LeftCtrl, LayerShift1, Space, Backspace, LayerShift2, Empty, Empty, Empty, Empty, Empty],
];
...
pub const SYMBOLS_LAYER_MAPPING: [[KeyCode; NUM_COLS]; NUM_ROWS] = [
    ...
    [Empty, Tilde, Hash, Asterisk, Equals, Minus, Empty, Empty, Empty, LeftSquareBracket, RightSquareBracket, Empty, Empty, Empty],
